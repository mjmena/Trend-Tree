...
CREATE TABLE IF NOT EXISTS MCC_RAW.MARKETING_DEV.STG_EXTERNAL_SIGNALS_TEST (
  SIGNAL_ID         VARCHAR(16777216),  -- widened from 255 with production — see sql/alter_signal_id_widen.sql
  ...
  URL               VARCHAR(16777216)  -- added 2026-06-10; table had drifted from production (proc writes URL since the url migration)
